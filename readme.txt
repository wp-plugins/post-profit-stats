...
== Description ==
The basic idea of this plugin is so you can see the total number of post views per user/author with detailed totals and grand totals. You can also sort by date.
